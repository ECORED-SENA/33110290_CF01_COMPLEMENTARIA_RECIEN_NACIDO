  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Enfoque Antenatal de Riesgo

    .row.align-items-center
      .col-md-8.mb-4(data-aos="fade-right")
        p En el enfoque de 
          span.etiqueta.fw-bold riesgo reproductivo
          |  se deben tener en cuenta algunas consideraciones, que como bien se define en la palabra antenatal, hace referencia a lo preconcepcional y se refiere a la identificación de factores de riesgo prenatal, perinatal y neonatales para el recién nacido. El seguimiento durante la gestación y el parto se denominan factores de 
          span.etiqueta.fw-bold riesgo obstétrico
          |; y desde las 28 semanas hasta los 28 primeros días de vida del neonato se llama 
          span.etiqueta.fw-bold riesgo perinatal
          |. Estos tres conceptos hacen que el enfoque de riesgo se defina de una manera más integrada.
    ...
    .row.justify-content-center
      .col-md-8.mb-4(data-aos="fade-right")
        AcordionA(tipo="b" clase-tarjeta="tarjeta bg-4")
          .row(titulo="Antecedentes reproductivos")
            p Son relacionados en la historia clínica, siendo una de las herramientas con mayor relevancia al lograr identificar aquellos factores de riesgo que no solo son encontrados en la concepción, sino en la preconcepción. Al hablar de riesgos podemos encontrar: aborto, parto pretérmino, restricción de crecimiento en las gestas, muerte fetal, cesáreas, antecedentes quirúrgicos y enfermedad producida por el embarazo como la hipertensión y la diabetes gestacional, entre otras complicaciones.
          .row(titulo="Edad materna")
    ...
    .row.justify-content-center
      ...
      .col-md-8.mb-4(data-aos="fade-left")
        AcordionA(tipo="b" clase-tarjeta="tarjeta bg-4")
          .row(titulo="Edad paterna avanzada")
            p Un factor de riesgo para la concepción no solo es tener presente a la madre, sino también al futuro padre quien si bien es cierto cumple un papel importante para el desarrollo y acompañamiento de la madre y el niño o niña. La edad avanzada en el hombre tiene un aumento en el riesgo de malformaciones debido a la fuerza y vitalidad que debería tener el esperma.
          .row(titulo="Consanguinidad")
            p La valoración de este factor es indispensable para evitar riesgos congénitos los cuales muchas veces de acuerdo al grado de consanguinidad, pueden afectar el adecuado desarrollo de la concepción.
          .row(titulo="Etnia")
            p Los grupos étnicos como factor de riesgo, permiten identificar la presencia de malformaciones congénitas como: polidactilia, siendo unos de los más frecuentes, paladar hendido, hipostasias y alteraciones de las globinas, como la anemia falciforme, las cardiopatías o la Beta Talasemia.
          .row(titulo="Ocupación")
            p Las condiciones laborales son también un punto a indagar dentro del seguimiento que se lleva tanto en la preconcepción como en la concepción, teniendo en cuenta que como factor de riesgo los resultados adversos encontrados son: aborto, muerte fetal, parto de pretérmino, bajo peso al nacer y algunos defectos congénitos; todo esto, debido a factores como:  
            ul.lista-ul--color.fa-ul
              li.mb-1 
                i.fas.fa-chevron-right
                | Carga laboral con exceso de tiempo. 
              li.mb-1 
                i.fas.fa-chevron-right
                | Condiciones inadecuadas donde no tiene una pausa activa o receso de acuerdo a la condición de la gestante. 
              li.mb-0
                i.fas.fa-chevron-right
                | Exposición con agentes químicos y que pueden resultar causando intoxicación de acuerdo al tipo de sustancia.

    p.mb-4(data-aos="fade") Además de los factores analizados anteriormente, existen otros aspectos para tener en cuenta, al momento de identificar factores de riesgo antenatal, como son:

    .row.justify-content-center(data-aos="fade-down")
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj1.svg' alt='')
          p.mb-0 Antecedentes obstétricos
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj2.svg' alt='')
          p.mb-0 Enfermedades crónicas
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj3.svg' alt='')
          p.mb-0 Estado nutricional
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj4.svg' alt='')
          p.mb-0 Consumo de sustancias psicoactivas
    ...
    .row.justify-content-center(data-aos="fade-down")
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj5.svg' alt='')
          p.mb-0 Control prenatal
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj6.svg' alt='')
          p.mb-0 Infecciones
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj7.svg' alt='')
          p.mb-0 Edad
      .col-lg-2.col-md-3.col-6.mb-4
        .tarjeta.bg-1.p-4.text-center.h-100
          .row.justify-content-center.mb-3
            .col-lg-8.col-9.col-md-11
              img(src='@/assets/curso/temas/t2/tarj8.svg' alt='')
          p.mb-0 Antecedentes genéticos
    ...
    #t_2_2
    .titulo-segundo.color-acento-contenido(data-aos="fade")
      h2 2.2  Evaluación del riesgo materno perinatal

    .row.fondo-gris.align-items-center.py-5
    ...
    #t_2_4
    .titulo-segundo.color-acento-contenido(data-aos="fade")
      h2 2.4 Intervenciones colectivas

    p.mb-4(data-aos="fade") Los entornos favorables para la intervención permiten un acercamiento adecuado en el seguimiento de la salud sexual y reproductiva a la madre y al recién nacido. Los lineamientos técnicos y operativos cuentan con las definiciones, objeto y la población a la cual la Ruta Integral para la promoción y mantenimiento de la salud, debe ejecutar de forma integrada en entornos familiares, educativos, comunitarios, institucionales y laborales de acuerdo a la situación de la gestante y según el respectivo abordaje e intervenciones individuales o colectivas.

    figure(data-aos="fade-down")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/zBG8Rz2Isyg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      figcaption Video. Intervenciones Colectivas
